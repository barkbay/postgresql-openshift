...
export LOGGING_COLLECTOR=${LOGGING_COLLECTOR:-off}
export CLIENT_MIN_MESSAGES=${CLIENT_MIN_MESSAGES:-NOTICE}
export LOG_MIN_MESSAGE=${LOG_MIN_MESSAGE:-INFO}
export LOG_STATEMENT=${LOG_STATEMENT:-none}
export LOG_MIN_DURATION_STATEMENT=${LOG_MIN_DURATION_STATEMENT:-250}
